...
/*   Updated: 2025/09/11 20:25:02 by mhotting         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
Span::iterator Span::begin() { return this->_content.begin(); }

Span::iterator Span::end() { return this->_content.end(); }

Span::const_iterator Span::begin() const { return this->_content.begin(); }

Span::const_iterator Span::end() const { return this->_content.end(); }
